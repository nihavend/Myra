...
public class Commandability {
	...
	public static boolean isStartable(AbstractJobType abstractJobType) {
		return LiveStateInfoUtils.equalStates(LiveStateInfoUtils.getLastStateInfo(abstractJobType), StateName.PENDING) && !LiveStateInfoUtils.equalStatesPD(abstractJobType) && (abstractJobType.getDependencyList() == null || abstractJobType.getDependencyList().sizeOfItemArray() == 0);
	}
